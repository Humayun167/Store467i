...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Store467i — Premium Source Codes & AI Prompts" },
      {
        name: "description",
        content:
          "A premium marketplace for source codes, AI prompts, templates and digital products with instant download.",
      },
      { name: "author", content: "Store467i" },
